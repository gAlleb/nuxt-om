<template>
    ...
    <div class="flex relative overflow-hidden dark:hidden font-tenor" style="background: url('/cdp_stream.jpg') center 40% no-repeat; background-size: cover; height: 45vh;  ">
    ...
    <h1 class="text-2xl sm:text-3xl text-sxvx-light text-center" style="text-shadow: 1px 2px 5px rgba(0,0,0,0.3);">
      jazz, chanson, Parisian spirit
    </h1>
    </div>
  
  
    </div>
    <div class="hidden relative overflow-hidden dark:flex font-tenor" style="background: url('/cdp_stream.jpg') center 40% no-repeat; background-size: cover; height: 45vh;  ">
