<template>
    ...
    <div class="hidden relative overflow-hidden dark:flex font-UNSCII" style="background: url('/core_long.png') center 40% no-repeat; background-size: cover; height: 45vh;  ">
